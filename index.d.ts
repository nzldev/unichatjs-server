...
declare function ExpressUniChatServer(server: Server, options?: IConfig): CustomExpress;
declare function UniChatJsServer(options?: Optional<IConfig>, callback?: (server: Server) => void): CustomExpress;

export { ExpressUniChatServer, UniChatJsServer };
